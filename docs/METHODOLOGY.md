...
The unit of analysis is an attribution claim linking:
...
2. Extract bounded passages.
3. Record non-causal observations.
4. Model events, actors, mechanisms, and media.
...
A hypothesis involving a nonhuman spiritual agent must remain proposed, identify
